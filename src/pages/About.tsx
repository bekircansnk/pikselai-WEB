        ...
        <MainLayout transparentHeader={true} headerLightText={true}>
            ...
            <Section mood="dark" className="py-24 text-center">
                <div className="max-w-3xl mx-auto space-y-6">
                    ...
                    <Button size="lg" className="bg-[#E2FF65] hover:bg-[#D4F054] text-bor-primary-900 rounded-full px-8 h-14 font-bold" onClick={() => navigate('/iletisim')}>
                        Demo Talep Et
                    </Button>
                </div>
            </Section>
...
function ValueBlock({ title, description, icon }: { title: string; description: string; icon: React.ReactNode }) {
    return (
        <div className="text-center p-8 rounded-2xl border border-bor-primary-100 hover:border-[#86AA00]/30 transition-colors">
